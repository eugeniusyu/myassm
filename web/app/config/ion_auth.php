 ...
 */
$config['site_title']                 = "Menya Sandaime Russell";       // Site Title, example.com This is not more functional
$config['admin_email']                = "menya.melb.stock@gmail.com"; // Admin Email, admin@example.com This is not more functional
$config['default_group']              = 'manager';           // Default group, use name
